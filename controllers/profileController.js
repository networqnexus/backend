...
exports.updateProfile = async (req, res) => {
  try {
    const allowed=["headline","bio","website","skills","goals","openToWork","location","experience","education","certifications","name","contactNumber","hideOnlineStatus","role","notificationPreferences"];
    const updates={};
